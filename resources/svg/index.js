...
module.exports = {
  ...
  rocket: size => {
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 512 512' width={size + 'px'} height={size + 'px'}>
          <path fill='currentColor' d='M477.64 38.26a4.75 4.75 0 00-3.55-3.66c-58.57-14.32-193.9 36.71-267.22 110a317 317 0 00-35.63 42.1c-22.61-2-45.22-.33-64.49 8.07C52.38 218.7 36.55 281.14 32.14 308a9.64 9.64 0 0010.55 11.2l87.31-9.63a194.1 194.1 0 001.19 19.7 19.53 19.53 0 005.7 12L170.7 375a19.59 19.59 0 0012 5.7 193.53 193.53 0 0019.59 1.19l-9.58 87.2a9.65 9.65 0 0011.2 10.55c26.81-4.3 89.36-20.13 113.15-74.5 8.4-19.27 10.12-41.77 8.18-64.27a317.66 317.66 0 0042.21-35.64C441 232.05 491.74 99.74 477.64 38.26zM294.07 217.93a48 48 0 1167.86 0 47.95 47.95 0 01-67.86 0z' />
          <path fill='rgb(250, 100, 155)' d='M168.4 399.43c-5.48 5.49-14.27 7.63-24.85 9.46-23.77 4.05-44.76-16.49-40.49-40.52 1.63-9.11 6.45-21.88 9.45-24.88a4.37 4.37 0 00-3.65-7.45 60 60 0 00-35.13 17.12C50.22 376.69 48 464 48 464s87.36-2.22 110.87-25.75A59.69 59.69 0 00176 403.09c.37-4.18-4.72-6.67-7.6-3.66z' />
        </svg>
      </div>
    )
  },
    ...
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path fill='currentColor' d='M13 17.5a1 1 0 11-2 0 1 1 0 012 0zm-.25-8.25a.75.75 0 00-1.5 0v4.5a.75.75 0 001.5 0v-4.5z' />
          <path fill='currentColor' d='M9.836 3.244c.963-1.665 3.365-1.665 4.328 0l8.967 15.504c.963 1.667-.24 3.752-2.165 3.752H3.034c-1.926 0-3.128-2.085-2.165-3.752L9.836 3.244zm3.03.751a1 1 0 00-1.732 0L2.168 19.499A1 1 0 003.034 21h17.932a1 1 0 00.866-1.5L12.866 3.994z' />
        </svg>
      </div>
    )
  },
  chevron: size => {
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path fill='currentColor' d='M18.78 15.28a.75.75 0 000-1.06l-6.25-6.25a.75.75 0 00-1.06 0l-6.25 6.25a.75.75 0 101.06 1.06L12 9.56l5.72 5.72a.75.75 0 001.06 0z' />
        </svg>
      </div>
    )
  },
  ...
  checklist: size => {
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path fill='currentColor' d='M3.5 3.75a.25.25 0 01.25-.25h13.5a.25.25 0 01.25.25v10a.75.75 0 001.5 0v-10A1.75 1.75 0 0017.25 2H3.75A1.75 1.75 0 002 3.75v16.5c0 .966.784 1.75 1.75 1.75h7a.75.75 0 000-1.5h-7a.25.25 0 01-.25-.25V3.75z' />
          <path fill='currentColor' d='M6.25 7a.75.75 0 000 1.5h8.5a.75.75 0 000-1.5h-8.5zm-.75 4.75a.75.75 0 01.75-.75h4.5a.75.75 0 010 1.5h-4.5a.75.75 0 01-.75-.75zm16.28 4.53a.75.75 0 10-1.06-1.06l-4.97 4.97-1.97-1.97a.75.75 0 10-1.06 1.06l2.5 2.5a.75.75 0 001.06 0l5.5-5.5z' />
        </svg>
      </div>
    )
  },
  ...
  inventory: size => {
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path fill='currentColor' d='M2.75 2A1.75 1.75 0 001 3.75v3.5C1 8.216 1.784 9 2.75 9h18.5A1.75 1.75 0 0023 7.25v-3.5A1.75 1.75 0 0021.25 2H2.75zm18.5 1.5H2.75a.25.25 0 00-.25.25v3.5c0 .138.112.25.25.25h18.5a.25.25 0 00.25-.25v-3.5a.25.25 0 00-.25-.25z' />
          <path fill='currentColor' d='M2.75 10a.75.75 0 01.75.75v9.5c0 .138.112.25.25.25h16.5a.25.25 0 00.25-.25v-9.5a.75.75 0 011.5 0v9.5A1.75 1.75 0 0120.25 22H3.75A1.75 1.75 0 012 20.25v-9.5a.75.75 0 01.75-.75z' />
          <path fill='currentColor' d='M9.75 11.5a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5h-4.5z' />
        </svg>
      </div>
    )
  },
  ruby: size => {
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path fill='currentColor' d='M5.873 3.26A.75.75 0 016.44 3h11.31a.75.75 0 01.576.27l5 6a.75.75 0 01-.028.992l-10.75 11.5a.75.75 0 01-1.096 0l-10.75-11.5a.75.75 0 01-.02-1.003l5.19-6zm.91 1.24L2.258 9.73 12 20.153l9.75-10.43L17.399 4.5H6.783z' />
        </svg>
      </div>
    )
  },
  grab: size => {
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path fill='currentColor' d='M15 18a1 1 0 100-2 1 1 0 000 2zm1-6a1 1 0 11-2 0 1 1 0 012 0zm-7 6a1 1 0 100-2 1 1 0 000 2zm0-5a1 1 0 100-2 1 1 0 000 2zm7-6a1 1 0 11-2 0 1 1 0 012 0zM9 8a1 1 0 100-2 1 1 0 000 2z' />
        </svg>
      </div>
    )
  },
  diff: size => {
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path fill='currentColor' fillRule='evenodd' d='M12.25 3.5a.75.75 0 01.75.75V8.5h4.25a.75.75 0 010 1.5H13v4.25a.75.75 0 01-1.5 0V10H7.25a.75.75 0 010-1.5h4.25V4.25a.75.75 0 01.75-.75zM6.562 19.25a.75.75 0 01.75-.75h9.938a.75.75 0 010 1.5H7.312a.75.75 0 01-.75-.75z' />
        </svg>
      </div>
    )
  },
  people: size => {
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 24 24' width={size + 'px'} height={size + 'px'}>
          <path fill='currentColor' fillRule='evenodd' d='M3.5 8a5.5 5.5 0 118.596 4.547 9.005 9.005 0 015.9 8.18.75.75 0 01-1.5.045 7.5 7.5 0 00-14.993 0 .75.75 0 01-1.499-.044 9.005 9.005 0 015.9-8.181A5.494 5.494 0 013.5 8zM9 4a4 4 0 100 8 4 4 0 000-8z' />
          <path fill='currentColor' d='M17.29 8c-.148 0-.292.01-.434.03a.75.75 0 11-.212-1.484 4.53 4.53 0 013.38 8.097 6.69 6.69 0 013.956 6.107.75.75 0 01-1.5 0 5.193 5.193 0 00-3.696-4.972l-.534-.16v-1.676l.41-.209A3.03 3.03 0 0017.29 8z' />
        </svg>
      </div>
    )
  },
  ...
  expand: size => {
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 448 512' width={size + 'px'} height={size + 'px'}>
          <path fill='currentColor' fillRule='evenodd'  d='M0 180V56c0-13.3 10.7-24 24-24h124c6.6 0 12 5.4 12 12v40c0 6.6-5.4 12-12 12H64v84c0 6.6-5.4 12-12 12H12c-6.6 0-12-5.4-12-12zM288 44v40c0 6.6 5.4 12 12 12h84v84c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12V56c0-13.3-10.7-24-24-24H300c-6.6 0-12 5.4-12 12zm148 276h-40c-6.6 0-12 5.4-12 12v84h-84c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h124c13.3 0 24-10.7 24-24V332c0-6.6-5.4-12-12-12zM160 468v-40c0-6.6-5.4-12-12-12H64v-84c0-6.6-5.4-12-12-12H12c-6.6 0-12 5.4-12 12v124c0 13.3 10.7 24 24 24h124c6.6 0 12-5.4 12-12z' />
        </svg>
      </div>
    )
  },
    ...
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 170 170' width={size + 'px'} height={size + 'px'}>
          <polygon class='cls-1' points='148.36 68.2 140.59 68.2 140.59 60.57 140.46 60.57 134.7 60.57 134.11 60.57 134.11 68.2 126.35 68.2 126.35 74.31 134.11 74.31 134.11 81.95 140.59 81.95 140.59 74.31 148.36 74.31 148.36 68.2' />
          <path class='cls-1' d='M47.47,96a14.52,14.52,0,0,1-6.32,1.31c-6.46,0-11.7-4.66-11.7-11.46s5-11.27,11.75-11.27a15.07,15.07,0,0,1,8.45,2.33l3-5.34c-1.27-.83-4.86-3.25-11.71-3.25C30.13,68.32,22.5,76,22.5,85.85s7.63,17.48,18.26,17.48c7.14,0,11.17-2.57,13-4V85.9H47.47Z' />
          <path class='cls-1' d='M87.41,80.89c0-7.84-5.69-12.69-14.24-12.69H60.63v35.13h6.89v-10h6l6.85,10h8.14l-8-11.59A11.48,11.48,0,0,0,87.41,80.89ZM72.57,87.24h-5v-13h5.1c4.55,0,7.65,2.44,7.65,6.64C80.27,84.74,77.22,87.24,72.57,87.24Z' />
          <rect class='cls-1' x='94.59' y='68.2' width='6.9' height='35.13' />
          <path class='cls-1' d='M140.56,86.06h0V85h-6.43v1.06s-.07,2.56-.18,3.4c-.66,4.91-5.33,7.78-11.29,7.78h-6.34V74.3h6.38V68.2H109.42v35.13H123c9.74,0,16.83-5.32,17.6-13.87C140.64,88.61,140.56,86.06,140.56,86.06Z' />
